...
| 2b. | Substrate module: New ZKP backend support | Bulletproof style proofs using Curve25519 |
...
### Milestone 2 — Toolchain: implement relayer, WASM bindings for zero-knowledge gadgets, types APIs, and integrate into a dApp
